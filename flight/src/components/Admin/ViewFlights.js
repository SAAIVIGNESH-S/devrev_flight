...
const ViewFlights = (props) => {
  ...
  const [viewingFlight, setViewingFlight] = useState();
  ...
  return (
    <Wrapper>
      {!isViewing ? (
          ...
          >
            ...
            {flights.map((flight) => (
              ...
              >
                ...
                <Button onClick={() => viewHandler(flight)} color="primary">
                  View Booking {flight["booked_seats"]}/{flight["seat_count"]}
                </Button>
              </Card>
            ))}
          </div>
        ...
        <ViewBooking flight={viewingFlight} />
      )}
    </Wrapper>
  );
};
